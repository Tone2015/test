$(function(){
	...
	$pintuercheck=function(element,type,value){
		...
		switch(type){
			...
			case "phone":return /^0?(13|15|18|14|17)[0-9]{9}$/.test($pintu);break;
	...
	$showdialogs=function(e){
		...
		var getClass = getid.substr(1, getid.length);
		...
		detail='<div class="dialog-win '+getClass+'" style="position:fixed;width:'+width+';z-index:11;">';
